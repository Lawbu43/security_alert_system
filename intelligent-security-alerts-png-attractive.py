...
<body class="bg-gray-100 font-sans">
    ...
    <header class="bg-gradient-to-r from-blue-700 to-blue-500 text-white py-16">
        <div class="container mx-auto px-4 text-center">
            <h1 class="text-4xl md:text-5xl font-bold mb-4">Intelligent Security Alert System</h1>
            <p class="text-lg md:text-xl mb-6">Stay informed with real-time, secure SMS alerts for critical incidents.</p>
            <a href="/subscribe" class="inline-block bg-white text-blue-700 font-semibold py-3 px-6 rounded-lg shadow-md hover:bg-gray-100 transition">Subscribe Now</a>
        </div>
    </header>
    ...
    <section class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <!-- Send Alerts Card -->
            <a href="/trigger_alert_form" class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition transform hover:-translate-y-1">
                <h3 class="text-xl font-semibold text-gray-800 mb-2">Send Alerts</h3>
                <p class="text-gray-600">Trigger coded SMS alerts to notify personnel of security incidents.</p>
            </a>
            <!-- View Logs Card -->
            <a href="/logs" class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition transform hover:-translate-y-1">
                <h3 class="text-xl font-semibold text-gray-800 mb-2">View Logs</h3>
                <p class="text-gray-600">Review sent and received messages for audit and tracking.</p>
            </a>
            <!-- Subscribe Card -->
            <a href="/subscribe" class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition transform hover:-translate-y-1">
                <h3 class="text-xl font-semibold text-gray-800 mb-2">Subscribe</h3>
                <p class="text-gray-600">Join the alert system to receive real-time notifications.</p>
            </a>
            <!-- About Card -->
            <a href="/about" class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition transform hover:-translate-y-1">
                <h3 class="text-xl font-semibold text-gray-800 mb-2">About</h3>
                <p class="text-gray-600">Learn more about Intelligent Security's mission and system.</p>
            </a>
        </div>
    </section>
    ...
    <footer class="bg-gray-800 text-white py-6">
        <div class="container mx-auto px-4 text-center">
            <p>&copy; 2025 Intelligent Security. All rights reserved.</p>
        </div>
    </footer>

    <script>
        // Handle alert form navigation (client-side for now, requires auth in production)
        document.querySelector('a[href="/trigger_alert_form"]').addEventListener('click', (e) => {
            e.preventDefault();
            // Replace with auth check in production
            window.location.href = '/trigger_alert_form';
        });
    </script>
</body>
</html>

intelligent-security-alerts/app/templates/about.html
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>About Intelligent Security</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="icon" href="{{ url_for('static', filename='favicon.ico') }}">
</head>
<body class="bg-gray-100 font-sans">
    <header class="bg-blue-700 text-white py-6">
        <div class="container mx-auto px-4 text-center">
            <h1 class="text-3xl font-bold">About Intelligent Security</h1>
        </div>
    </header>
    <section class="container mx-auto px-4 py-12">
        <div class="bg-white rounded-lg shadow-md p-6 max-w-3xl mx-auto">
            ...
            <p class="text-gray-600 mb-4">
                Intelligent Security is dedicated to providing cutting-edge, secure communication solutions for critical incidents. Our SMS alert system ensures rapid, discreet notifications to keep personnel and clients safe in Papua New Guinea and beyond.
            </p>
            <h2 class="text-2xl font-semibold text-gray-800 mb-4">Why Choose Us?</h2>
            <ul class="list-disc list-inside text-gray-600 mb-4">
                <li>Real-time, coded alerts for maximum discretion.</li>
                <li>Responsive interface accessible on any device.</li>
                <li>Compliance with PNG telecommunications regulations.</li>
                <li>Seamless integration with existing security systems.</li>
            </ul>
            <div class="text-center">
                <a href="/subscribe" class="inline-block bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700">Join Our Alert System</a>
            </div>
        </div>
    </section>
    <footer class="bg-gray-800 text-white py-6">
        <div class="container mx-auto px-4 text-center">
            <p>&copy; 2025 Intelligent Security. All rights reserved.</p>
            <a href="/" class="text-blue-300 hover:text-blue-100">Back to Home</a>
        </div>
    </footer>
</body>
</html>
...
intelligent-security-alerts/app/templates/trigger_alert_form.html
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Send Alerts - Intelligent Security</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="icon" href="{{ url_for('static', filename='favicon.ico') }}">
</head>
<body class="bg-gray-100 font-sans">
    <div class="container mx-auto p-4 max-w-2xl">
        <h1 class="text-3xl font-bold text-center text-gray-800 mb-6">Send Security Alerts</h1>
        <div class="bg-white p-6 rounded-lg shadow-md">
            <h2 class="text-xl font-semibold mb-4">Trigger Alert</h2>
...
def test_about(client):
    ...
    assert response.status_code == 200
    assert b"About Intelligent Security" in response.data
...
A responsive, generative SMS alert system for Intelligent Security in Papua New Guinea, sending coded alerts via a Twilio +675 number and forwarding replies to a local +675 cell number. Features an attractive main page with links to system components and a public subscription interface.
...
- Attractive main page with hero section and navigation cards to Send Alerts, View Logs, Subscribe, and About.
- Responsive web interface (Tailwind CSS) for admin and public access.
...
6. Access at `http://localhost:5000`:
   - Main page: `/` (links to all features).
   - Admin: `/trigger_alert_form` (send alerts), `/logs` (view logs).
   - Public: `/subscribe` (opt-in), `/about` (info).
...
- **Twilio**:
  ...
  - SMS (1,100 sent, 500 received, 500 forwarded, 100 confirmation): (1,100 × $0.0485) + (1,000 × $0.0135) = $66.85/month = $802.20/year.
